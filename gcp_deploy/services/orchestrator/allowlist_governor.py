...
def _bootstrap_reference_signoffs():
    for key in (
        ...
        "alloydb_kill_blocking_session", "alloydb_kill_runaway_query",
        "alloydb_terminate_idle_in_transaction", "alloydb_reset_all_connections",
        "alloydb_set_statement_timeout",
        "mysql_kill_blocking_session", "mysql_kill_runaway_query",
        "mysql_terminate_idle_in_transaction", "mysql_reset_all_connections",
    ):
